    ...
    <main className="shell">
      <section className="intro" aria-labelledby="page-title">
        ...
        <p className="lede">
          ...
          MVP will index a repository, react to PR webhooks, retrieve relevant
          code context, and post one evidence-based review comment.
        </p>
      </section>
      ...
      <section className="status-panel" aria-labelledby="status-title">
        <div>
          ...
          <h2 id="status-title">Stage 1: Foundation</h2>
        </div>
